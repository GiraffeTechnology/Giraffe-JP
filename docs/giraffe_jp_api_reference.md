...
|---|---|---|
| `SERVICE_NODE_CREATED` | `"SERVICE_NODE_CREATED"` | Service Core |
| `CONFIRMATION_REQUEST_CREATED` | `"CONFIRMATION_REQUEST_CREATED"` | Service Core |
| `CONFIRMATION_REQUEST_CONFIRMED` | `"CONFIRMATION_REQUEST_CONFIRMED"` | Service Core |
| `CONFIRMATION_REQUEST_REJECTED` | `"CONFIRMATION_REQUEST_REJECTED"` | Service Core |
| `CONFIRMATION_REQUEST_ESCALATED` | `"CONFIRMATION_REQUEST_ESCALATED"` | Service Core |
| `CUSTOMER_SERVICE_TASK_CREATED` | `"CUSTOMER_SERVICE_TASK_CREATED"` | Service Core |
| `CUSTOMER_SERVICE_TASK_STARTED` | `"CUSTOMER_SERVICE_TASK_STARTED"` | Service Core |
| `CUSTOMER_SERVICE_TASK_COMPLETED` | `"CUSTOMER_SERVICE_TASK_COMPLETED"` | Service Core |
| `CUSTOMER_SERVICE_TASK_ESCALATED` | `"CUSTOMER_SERVICE_TASK_ESCALATED"` | Service Core |
